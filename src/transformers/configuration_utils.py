...
class PretrainedConfig(PushToHubMixin):
    ...
    def from_dict(cls, config_dict: Dict[str, Any], **kwargs) -> "PretrainedConfig":
        ...
        config_dict["additional_loss_layer"] = kwargs.pop("additional_loss_layer", None)
        config_dict["contrastive_loss_temperature"] = kwargs.pop("contrastive_loss_temperature", None)
        config_dict["distance_function"] = kwargs.pop("distance_function", None)
        config_dict["contrastive_loss_weight"] = kwargs.pop("contrastive_loss_weight", None)
        config_dict["only_train_contrastive"] = kwargs.pop("only_train_contrastive", None)
        config_dict["only_train_language_modeling"] = kwargs.pop("only_train_language_modeling", None)
        config_dict["unidirectional_contrastive_loss"] = kwargs.pop("unidirectional_contrastive_loss", None)
        config_dict["contrastive_pooling_type"] = kwargs.pop("contrastive_pooling_type", None)

        config_dict["inject_Ws"] = kwargs.pop("inject_Ws", False)
        config_dict["alignment_matrices_path"] = kwargs.pop("alignment_matrices_path", None)
        config_dict["apply_inverse"] = kwargs.pop("apply_inverse", False)
        ...
        # if "additional_loss_layer" in kwargs:
        #     config["additional_loss_layer"] = kwargs["additional_loss_layer"]
        # if "contrastive_loss_temperature" in kwargs:
        #     config["contrastive_loss_temperature"] = kwargs["contrastive_loss_temperature"]
        # if "distance_function" in kwargs:
        #     config["distance_function"] = kwargs["cosine"]
